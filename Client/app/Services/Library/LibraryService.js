...
var LibraryService = /** @class */ (function () {
    function LibraryService(http) {
        this.http = http;
        this.libraryServiceURL = 'http://localhost:50980/Libraries/';
    }
    ...
    LibraryService.prototype.addLibrary = function (library) {
        return this.http.post(this.libraryServiceURL + "AddNewLibrary", library)
            .map(this.extractData)
            .catch(this.handleError);
    };
    LibraryService.prototype.getLibraryById = function (id) {
    ...
    //        .catch(this.handleError)
    //}
    LibraryService.prototype.editLibrary = function (library) {
        return this.http.post(this.libraryServiceURL + "SaveLibraries", library)
            .map(this.extractData)
            .catch(this.handleError);
    };
    LibraryService.prototype.deleteLibrary = function (library) {
        return this.http.post(this.libraryServiceURL + "DeleteLibrary", library)
            .map(this.extractData)
            .catch(this.handleError);
    };
    LibraryService.prototype.extractData = function (res) {
        var body = res.json();
        console.log(body);
        return body;
    };
